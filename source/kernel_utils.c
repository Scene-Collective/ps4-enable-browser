...
int kpayload_jailbreak(struct thread *td, struct kpayload_jailbreak_args *args) {
  ...
  *sceProcCap = 0xffffffffffffffff;
  ...
  if (fw_version == 0x350) {
    *(void **)(&sceRegMgrSetInt) = &kernel_ptr[K350_REG_MGR_SET_INT];
  } else if (fw_version == 0x355) {
    *(void **)(&sceRegMgrSetInt) = &kernel_ptr[K355_REG_MGR_SET_INT];
  } else if (fw_version == 0x370) {
    *(void **)(&sceRegMgrSetInt) = &kernel_ptr[K370_REG_MGR_SET_INT];
  } else if (fw_version == 0x400) {
    *(void **)(&sceRegMgrSetInt) = &kernel_ptr[K400_REG_MGR_SET_INT];
  } else if (fw_version == 0x401) {
    *(void **)(&sceRegMgrSetInt) = &kernel_ptr[K401_REG_MGR_SET_INT];
  } else if (fw_version == 0x405) {
    *(void **)(&sceRegMgrSetInt) = &kernel_ptr[K405_REG_MGR_SET_INT];
  } else if (fw_version == 0x406) {
    *(void **)(&sceRegMgrSetInt) = &kernel_ptr[K406_REG_MGR_SET_INT];
  } else if (fw_version == 0x407) {
    *(void **)(&sceRegMgrSetInt) = &kernel_ptr[K407_REG_MGR_SET_INT];
  } else if (fw_version == 0x450) {
    *(void **)(&sceRegMgrSetInt) = &kernel_ptr[K450_REG_MGR_SET_INT];
  } else if (fw_version == 0x455) {
    *(void **)(&sceRegMgrSetInt) = &kernel_ptr[K455_REG_MGR_SET_INT];
  } else if (fw_version == 0x470) {
    *(void **)(&sceRegMgrSetInt) = &kernel_ptr[K470_REG_MGR_SET_INT];
  } else if (fw_version == 0x471 || fw_version == 0x472 || fw_version == 0x473) {
    *(void **)(&sceRegMgrSetInt) = &kernel_ptr[K471_REG_MGR_SET_INT];
  } else if (fw_version == 0x474) {
    *(void **)(&sceRegMgrSetInt) = &kernel_ptr[K474_REG_MGR_SET_INT];
  } else if (fw_version == 0x500 || fw_version == 0x501) {
    *(void **)(&sceRegMgrSetInt) = &kernel_ptr[K500_REG_MGR_SET_INT];
  } else if (fw_version == 0x503) {
    *(void **)(&sceRegMgrSetInt) = &kernel_ptr[K503_REG_MGR_SET_INT];
    ...
    *(void **)(&sceRegMgrSetInt) = &kernel_ptr[K600_REG_MGR_SET_INT];
  } else if (fw_version == 0x620) {
    *(void **)(&sceRegMgrSetInt) = &kernel_ptr[K620_REG_MGR_SET_INT];
  } else if (fw_version == 0x650 || fw_version == 0x651) {
    *(void **)(&sceRegMgrSetInt) = &kernel_ptr[K650_REG_MGR_SET_INT];
  } else if (fw_version == 0x670 || fw_version == 0x671 || fw_version == 0x672) {
    *(void **)(&sceRegMgrSetInt) = &kernel_ptr[K670_REG_MGR_SET_INT];
  } else if (fw_version == 0x700 || fw_version == 0x701 || fw_version == 0x702) {
    *(void **)(&sceRegMgrSetInt) = &kernel_ptr[K700_REG_MGR_SET_INT];
  } else {
    return -1;
  }
